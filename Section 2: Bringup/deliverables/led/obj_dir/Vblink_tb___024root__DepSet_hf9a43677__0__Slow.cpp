...
VL_ATTR_COLD void Vblink_tb___024root___eval_static(Vblink_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vblink_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vblink_tb___024root___eval_static\n"); );
}
...
VL_ATTR_COLD void Vblink_tb___024root___eval_final(Vblink_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vblink_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vblink_tb___024root___eval_final\n"); );
}

VL_ATTR_COLD void Vblink_tb___024root___eval_settle(Vblink_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vblink_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vblink_tb___024root___eval_settle\n"); );
}
...
VL_ATTR_COLD void Vblink_tb___024root___dump_triggers__act(Vblink_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vblink_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vblink_tb___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vblink_tb___024root___dump_triggers__nba(Vblink_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vblink_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vblink_tb___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vblink_tb___024root___ctor_var_reset(Vblink_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vblink_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
