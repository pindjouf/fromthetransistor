...
VL_INLINE_OPT void Vtb___024root___nba_sequent__TOP__0(Vtb___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb__DOT__q = ((IData)(vlSelf->tb__DOT__reset)
                           ? 0U : (0xfU & ((IData)(1U) 
                                           + (IData)(vlSelf->tb__DOT__q))));
}
...
void Vtb___024root___timing_resume(Vtb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_h95cd1bbb__0.resume("@(posedge tb.clk)");
    }
...
void Vtb___024root___timing_commit(Vtb___024root* vlSelf) {
    ...
    // Body
    if ((! (1ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_h95cd1bbb__0.commit("@(posedge tb.clk)");
    }
}
